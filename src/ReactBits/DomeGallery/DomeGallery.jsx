...
import '../DomeGallery/DomeGallery.css';
...
function buildItems(pool, seg) {
  ...
  const normalizedImages = pool.map(image => {
    ...
    return { ...image, src: image.image || image.src || '', alt: image.title || image.alt || '', link: image.link || '' };
  });
...
export default function DomeGallery({
  ...
  const openItemFromElement = useCallback(
    el => {
      ...
      const tags = parent.dataset.tags ? JSON.parse(parent.dataset.tags) : [];

      if (title) {
        overlay.classList.add('project-card');
  ...
  return (
    <div
      ...
      style={{
        ...
        ['--opened-width']: openedImageWidth,
        ['--opened-height']: openedImageHeight
      }}
    >
